...
def upload_to_vk(video_path, description="", title=""):
    ...
    try:
        ...
        # Prepare message
        message = description if description else "📚 Legal history explained!\n\n#Law #History #Education"
        ...
        video = upload.video(
            ...
            name=title or 'Legal History Video',
        ...
        if "Access denied" in str(e):
            ...
            print("   See VK setup documentation for the easiest way to get this!")
...
def main():
    ...
    description = sys.argv[2] if len(sys.argv) > 2 else "Legal history explained! 📚"
    title = sys.argv[3] if len(sys.argv) > 3 else "Legal History"
